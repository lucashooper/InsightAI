        ...
        <View style={styles.modalContainer}>
          ...
          >
            <View style={styles.sheet}>
              ...
              {/* Title */}
              <Text style={styles.title}>{t('components.auth.signIn')}</Text>
              ...
              {onSelectApple && (
                ...
                >
                  ...
                  <Text style={styles.appleButtonText}>{t('components.auth.apple')}</Text>
                </TouchableOpacity>
              )}
              ...
              {onSelectGoogle && (
                ...
                >
                  ...
                  <Text style={styles.googleButtonText}>{t('components.auth.google')}</Text>
                </TouchableOpacity>
              )}
              ...
              >
                ...
                <Text style={styles.emailButtonText}>{t('components.auth.email')}</Text>
              </TouchableOpacity>

              {/* Terms */}
              <Text style={styles.terms}>
                {t('components.auth.termsPrefix')}{'\n'}
                <Text 
                  style={styles.termsLink}
                  onPress={() => Linking.openURL('https://www.apple.com/legal/internet-services/itunes/dev/stdeula/')}
                >
                  {t('components.auth.termsOfService')}
                </Text>{' '}{t('components.auth.and')}{' '}
                <Text 
                  style={styles.termsLink}
