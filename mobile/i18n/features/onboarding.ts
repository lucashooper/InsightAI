...
export const onboardingTranslations: Partial<Record<AppLanguage, TranslationTree>> = {
  "zh": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight 想发给您",
        "permissionType": "通知",
        "dontAllow": "不允许"
      },
      "rateUs": {
  ...
  "hi": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight आपको भेजना चाहता हूँ",
  ...
  "fr": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight souhaite vous envoyer",
  ...
  "de": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight möchte Ihnen senden",
  ...
  "ru": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight хотел бы отправить вам",
  ...
  "pt": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight gostaria de lhe enviar",
  ...
  "it": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight vorrebbe inviarti",
  ...
  "ro": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight ar dori să vă trimită",
  ...
  "az": {
    "onboarding": {
      "welcome": "Insight-ya xoş gəlmisiniz",
      "getStarted": "Başlayın",
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight sizə göndərmək istəyir",
      ...
      "postPurchase": {
        "title": "Insight-ya xoş gəlmisiniz",
  ...
  "nl": {
    "onboarding": {
      ...
      "notifications": {
        ...
        "permissionRequest": "Insight wil u graag sturen",
