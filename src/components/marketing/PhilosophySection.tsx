        ...
        <div className="philosophy-content">
          <div className="philosophy-text">
            <div className="philosophy-item">
              ...
              <p className="philosophy-description">
                Insight stores notes <span className="text-highlight">privately on your device</span>, so you can access them quickly, 
            ...
            <div className="philosophy-item">
              ...
              <p className="philosophy-description">
                ...
                shape Insight to fit your way of thinking.
              </p>
            </div>
            ...
            <div className="philosophy-item">
              ...
              <p className="philosophy-description">
                Insight uses <span className="text-highlight">open file formats</span>, so you're never locked in. 
          ...
          <div className="philosophy-visual">
            <div className="logo-container">
              <img src="./InsightAI-New-Logo.png" alt="Insight" className="philosophy-logo" />
            </div>
            <h2 className="philosophy-brand">
              Insight
            </h2>
            <p className="philosophy-cta-text">Free without limits.</p>
            <a href="/login" className="philosophy-cta-link">Get started</a>
          </div>
        </div>
